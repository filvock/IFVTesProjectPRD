...
namespace TesourariaIFV.Forms.ReportForms.Charts
{
    public partial class ChartPlanoDeContasTotaisMgnt : Form
    {
        public ChartPlanoDeContasTotaisMgnt()
        {
            InitializeComponent();
        ...
        private void reportPlanoDeContasOkButton_Click(object sender, EventArgs e)
        {
            if (checkBox3.Checked == true)
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisIgreja report = new Charts.ChartReports.PCCTotaisIgreja(dataInicial, dataFinal, reportPlanoDeContasComboBox.SelectedValue.ToString());
                    report.Show();
                ...
                if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisIgreja report = new Charts.ChartReports.PCCTotaisIgreja(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value, reportPlanoDeContasComboBox.SelectedValue.ToString());
                    report.Show();
            ...
            else if (checkBox2.Checked == true)
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisEstado report = new Charts.ChartReports.PCCTotaisEstado(dataInicial, dataFinal, comboBox2.SelectedValue.ToString());
                    report.Show();
                ...
                if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisEstado report = new Charts.ChartReports.PCCTotaisEstado(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value, comboBox2.SelectedValue.ToString());
                    report.Show();
            ...
            else if (checkBox1.Checked == true)
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisRegiao report = new TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisRegiao(dataInicial, dataFinal, comboBox1.SelectedItem.ToString());
                    report.Show();
                ...
                if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisRegiao report = new TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisRegiao(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value, comboBox1.SelectedItem.ToString());
                    report.Show();
            ...
            else
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisPais report = new Charts.ChartReports.PCCTotaisPais(dataInicial, dataFinal);
                    report.Show();
                ...
                if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.Charts.ChartReports.PCCTotaisPais report = new Charts.ChartReports.PCCTotaisPais(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value);
                    report.Show();
