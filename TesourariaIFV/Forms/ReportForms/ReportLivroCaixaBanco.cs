...
{
    public partial class ReportLivroCaixaBanco : Form
    {
        public ReportLivroCaixaBanco(DateTime dataInicial, DateTime dataFinal, string igreja, string saldo)
        {
            InitializeComponent();
        ...
        private void ReportLivroCaixaBanco_Load(object sender, EventArgs e)
        {
