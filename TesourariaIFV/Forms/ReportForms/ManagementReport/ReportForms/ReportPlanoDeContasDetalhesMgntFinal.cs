...
{
    public partial class ReportPlanoDeContasDetalhesMgntFinal : Form
    {
        public ReportPlanoDeContasDetalhesMgntFinal(DateTime dataInicial, DateTime dataFinal, string igreja)
        {
            InitializeComponent();
