...
{
    public partial class ReportEntradaSaida : Form
    {
        public ReportEntradaSaida()
        {
            InitializeComponent();
        ...
        private void reportPlanoDeContasOkButton_Click(object sender, EventArgs e)
        {
            ...
            else if (checkBox2.Checked == true)
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESEstado report = new ReportForms.ESEstado(dataInicial, dataFinal, comboBox2.SelectedValue.ToString());
                    report.Show();
                ...
                if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESEstado report = new ReportForms.ESEstado(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value, comboBox2.SelectedValue.ToString());
                    report.Show();
            ...
            else if (checkBox1.Checked == true)
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESRegiao report = new TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESRegiao(dataInicial, dataFinal, comboBox1.SelectedItem.ToString());
                    report.Show();
                ...
                if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESRegiao report = new TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESRegiao(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value, comboBox1.SelectedItem.ToString());
                    report.Show();
            ...
            else
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESPais report = new ReportForms.ESPais(dataInicial, dataFinal);
                    report.Show();
                ...
                if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESPais report = new TesourariaIFV.Forms.ReportForms.ManagementReport.ReportForms.ESPais(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value);
                    report.Show();
