...
{
    public partial class ReportPlanoDeContasTotais : Form
    {
        public ReportPlanoDeContasTotais()
        {
            InitializeComponent();
        ...
        private void reportPlanoDeContasOkButton_Click(object sender, EventArgs e)
        {
            ...
            if (info.GetRole() == "Igreja Local")
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.Reports_Forms.ReportPlanoDeContasTotaisFinal report = new ReportPlanoDeContasTotaisFinal(dataInicial, dataFinal, info.GetIgreja());
                    report.Show();
                    ...
                    if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                    {
                        ...
                        TesourariaIFV.Forms.Reports_Forms.ReportPlanoDeContasTotaisFinal report = new ReportPlanoDeContasTotaisFinal(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value, info.GetIgreja());
                        report.Show();
            ...
            else
            {
                if (reportPlanoDeContasMonthRadioButton.Checked == true)
                {
                    ...
                    TesourariaIFV.Forms.Reports_Forms.ReportPlanoDeContasTotaisFinal report = new ReportPlanoDeContasTotaisFinal(dataInicial, dataFinal, reportPlanoDeContasComboBox.SelectedValue.ToString());
                    report.Show();
                    ...
                    if (reportPlanoDeContasPeriodRadioButton.Checked == true)
                    {
                        ...
                        TesourariaIFV.Forms.Reports_Forms.ReportPlanoDeContasTotaisFinal report = new ReportPlanoDeContasTotaisFinal(reportPlanoDeContasInitialDateTimePicker.Value, reportPlanoDeContasFinalDateTimePicker.Value, reportPlanoDeContasComboBox.SelectedValue.ToString());
                        report.Show();
