...
{
    public partial class ReportLivroBanco : Form
    {
        public ReportLivroBanco(DateTime dataInicial, DateTime dataFinal, string igreja, string saldo)
        {
            InitializeComponent();
        ...
        private void ReportLivroBanco_Load(object sender, EventArgs e)
        {
