...
{
    public partial class ReportPlanoDeContasDetalhesFinal : Form
    {
        public ReportPlanoDeContasDetalhesFinal(DateTime dataInicial, DateTime dataFinal, string igreja)
        {
            InitializeComponent();
